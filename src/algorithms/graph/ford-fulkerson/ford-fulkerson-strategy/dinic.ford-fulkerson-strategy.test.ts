...
import { Dinic_FordFulkersonStrategy } from './dinic.ford-fulkerson-strategy';

describe('Dinic_FordFulkersonStrategy', () => {
  const strategy = new Dinic_FordFulkersonStrategy();
